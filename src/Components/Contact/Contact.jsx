...
const Contact = () => {
  return (
    <div className="flex flex-col text-gray-700 h-auto md:min-h-screen w-full justify-start items-start flex-wrap pt-20 pb-9 px-4 md:px-74">
      <p className="text-3xl font-bold">Contact Us</p>
     
      <ul className="w-full mt-4 mb-15 h-auto">
        ...
        <li className=" transition duration-300 flex items-center mb-2">
          <a href="tel:+8801700000000" className="flex items-center gap-2">
            <FontAwesomeIcon icon={faSquareWhatsapp} size="xl" className="text-inherit" />
            +880 1712 564429
          </a>
        </li>
        <li className=" transition duration-300 flex items-center mb-2">
          <a href="https://mail.google.com/mail/?view=cm&to=mahbubur.ice@gmail.com" target="blank" className="flex items-center gap-3">
            <FontAwesomeIcon icon={faEnvelope} size="lg" className="text-inherit" />
            contact@emtech-jkkniu.org
          </a>
        </li>
        <li className="transition duration-300 flex items-start gap-3 mb-2">
          ...
          <span> Department of EEE, 4th Floor, Science Building, JKKNIU, Trishal, Mymensingh-2224, BD</span>
        </li>
      </ul>
